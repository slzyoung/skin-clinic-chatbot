...
async def trigger_batch_summary_after_all_done(batch_id: str, expected_count: int, llm: BaseLLMAdapter, timeout_sec: int = 180):
    """
...
async def ingest_document(
    ...
    try:
        ...
        if batch_id and len(response_items) > 1 and llm:
            asyncio.create_task(
                trigger_batch_summary_after_all_done(batch_id, len(response_items), llm)
            )
