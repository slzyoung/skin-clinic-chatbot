            ...
            try:
                ...
                if api_key:
                    ...
                    prompt_text = (
                        ...
                        "Focus strictly on substantive information: product/treatment name, SKU / Product ID / Item Code (if visible on label/document), active ingredients, indications/benefits, target skin type/patient, directions for use, contraindications, dosage, packaging/volume, and clinical details.\n"
                        ...
                        "3. Extract fields dynamically based on the actual substantive content visible on the label/document (including explicit 'sku', 'product_id', or 'item_code' if present).\n"
                        "4. Preserve important terminology, ingredients, SKU codes, and names exactly as readable.\n"
                        ...
                        "2. Summary (Concise, structured summary of the product/document specifications, ingredients, SKU, and use cases.)\n"
                        "3. Extracted Information (Key-value map of substantive attributes: brand, sku, product_id, active_ingredients, skin_type, volume, benefits, usage, etc.)\n"
                        "4. Searchable Knowledge (Dense textual paragraph summarizing all key facts including SKU/Product ID to be embedded by RAG system.)\n\n"
                        "## Output Format\n"
