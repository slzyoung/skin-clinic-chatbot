  ...
  return (
    <Sidebar collapsible="icon" {...props} className="border-r border-border">
      <SidebarHeader className="px-4 pt-4 pb-0 group-data-[collapsible=icon]:p-2">
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton size="lg" render={<Link href="/functional/ingest" />} className="hover:bg-transparent hover:text-inherit active:bg-transparent cursor-default p-0 group-data-[collapsible=icon]:justify-center">
      ...
      <SidebarContent>
        <div className="px-4 pt-12 pb-2 group-data-[collapsible=icon]:p-2 group-data-[collapsible=icon]:pt-8">
          <Button render={<Link href="/functional/ingest" />} nativeButton={false} className="w-full justify-center bg-blue-500 hover:bg-blue-600 text-white shadow-none h-10 px-3 rounded-md group-data-[collapsible=icon]:size-8 group-data-[collapsible=icon]:p-0 shrink-0">
