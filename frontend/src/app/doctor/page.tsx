		...
		<div className="flex flex-col max-w-2xl mx-auto min-h-full w-full pt-10 pb-10 px-4">
			...
			<div className="grid grid-cols-2 gap-3 w-full mb-4 shrink-0">
				<button
					...
					className="flex flex-col items-start p-2.5 text-left rounded-md border border-border hover:border-zinc-300 hover:bg-zinc-50 transition-colors disabled:opacity-50"
				>
