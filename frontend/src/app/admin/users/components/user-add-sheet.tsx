import { RiImageAddLine, RiEyeLine } from "@remixicon/react"
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="relative">
                <Input id="name" placeholder="John Doe" className="border-gray-200 bg-white focus-visible:ring-blue-500" />
                <span className="absolute right-3 top-2.5 text-gray-400 text-sm pointer-events-none">parameters</span>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="relative">
                <Input id="email" type="email" placeholder="example@gmail.com" className="border-gray-200 bg-white focus-visible:ring-blue-500" />
                <span className="absolute right-3 top-2.5 text-gray-400 text-sm pointer-events-none">parameters</span>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="relative">
                <Input id="password" type="password" placeholder="********" className="border-gray-200 bg-white focus-visible:ring-blue-500 pr-10" />
