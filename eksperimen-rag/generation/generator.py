...
class GenerationPipeline:
    ...
    def generate_answer(
        ...
        # 2. Check if context is fallback/empty (Maaf, saya tidak menemukan informasi)
        # If retriever returned empty or fallback message due to confidence threshold or empty DB,
        # we bypass the LLM immediately to save cost and avoid hallucinations.
